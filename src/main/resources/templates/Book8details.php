...
//        $name = "WUTHERING HEIGHTS";
        if ($quantity_reached_5) {
            ...
            if ($new_quantity > 0 && $new_quantity <= 5) {
                ...
                if ($result->num_rows > 0) {
                    if ($quantity < 5) {
                        ...
                        if ($sum_quantity <= 5) {
                            ...
                            echo '<script>alert("Cannot save more than 5 books");</script>';
                        }
                    } else {
                        $stmt = $conn->prepare("UPDATE `cart` SET `protection` = ?, `giftpaper` = ? WHERE `productname` = ? AND `custid` = ?");
                        $stmt->bind_param("ssss", $protection, $gift, $name, $custid);
                ...
                echo '<script>alert("Each user can only purchase 5 books");</script>';
            }
        }
    }
} else {
...
<div class="Keeper">
    <div class="Product-image">
        ...
        <p class="p2">/</p>
        <p class="p3">02</p>
        <img src="BookProduct/BP8.png" alt="">
    ...
    <form action="Book8details.php" method="post">
        <div class="Product-info">
            <div class="Bookinfo">
                <p class="Name">ADVANTAGE OF SHE.</p>
                <p class="About">Arthur Conan Doyle. US</p>
                <p class="Type">BOOK: ADVENTURE / HORROR</p>
                <p class="Price">¥ 60.50<span>税込</span></p>
            </div>
            <div class="desc">
                <p>Organise your library any way you like. With collections, every one of
                    your books is exactly where you want it. Create your own collections and
                    get to them easily at any time. You can also revisit an old favourite
                    you’ve already read in the Finished collection. The Reading Now tab makes
                    it easy to get to the right page in an instant, whether you’re immersed in
                    a single story or bouncing between books. It’s also where you’ll find
                    personalised recommendations based on what you’ve been reading.
                </p>
            </div>
            <div class="extra-protection">
                <p class="p1">Need Extra Protection ?</p>
                <div class="Link">
                    <input class="i1" type="button" placeholder="Bubble Plastic" value="Bubble Plastic">
                    <input class="i2" type="button" placeholder="Wrapping (free)" value="Wrapping (free)">
                    <input type="hidden" name="protect" id="protect">
                </div>
                <p class="p2">Add a gift paper</p>
                <select name="gift">
                    <option value="No gift-paper">No gift-paper</option>
                    <option value="With gift-paper">With gift-paper</option>
                </select>
...
<script>
    ...
    var images = ['BookProduct/BP8.png', 'image2.jpg'];
    var currentIndex = 0;
    ...
    buttons.forEach(button => {
        ...
        button.addEventListener('click', () => {
            ...
            xhr.open('POST', 'Book1details.php');
