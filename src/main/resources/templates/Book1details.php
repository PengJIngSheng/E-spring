...
<div class="Keeper">
    <div class="Product-image">
        ...
        <p class="p2">/</p>
        <p class="p3">02</p>
        <img src="BookProduct/BP1.png" alt="">
    ...
    <form action="Book1details.php" method="post">
        <div class="Product-info">
            <div class="Bookinfo">
                <p class="Name">THE ART OF WAR</p>
                <p class="About">Sun Tzu. US</p>
                <p class="Type">BOOK: ADVENTURE / HORROR</p>
                <p class="Price">¥ 34.50<span>税込</span></p>
            </div>
            <div class="desc">
...
<script>
    ...
    var images = ['BookProduct/BP1.png', 'image2.jpg'];
    var currentIndex = 0;
