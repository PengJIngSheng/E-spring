...
<div class="Keeper">
    <div class="Product-image">
        ...
        <p class="p2">/</p>
        <p class="p3">02</p>
        <img src="BookProduct/BP4.png" alt="">
    ...
    <form action="Book4details.php" method="post">
        <div class="Product-info">
            <div class="Bookinfo">
                <p class="Name">WUTHERING HEIGHTS</p>
                <p class="About">Emily Brontë. NG</p>
                <p class="Type">BOOK: ADVENTURE / HORROR</p>
                <p class="Price">¥ 89.50<span>税込</span></p>
            </div>
            <div class="desc">
...
<script>
    ...
    var images = ['BookProduct/BP4.png', 'image2.jpg'];
    var currentIndex = 0;
    ...
    buttons.forEach(button => {
        ...
        button.addEventListener('click', () => {
            ...
            xhr.open('POST', 'Book4details.php');
