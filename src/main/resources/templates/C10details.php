...
<div class="Keeper">
    <div class="Product-image">
        ...
        <p class="p2">/</p>
        <p class="p3">02</p>
        <img src="CoffeeProduct/c10.png" alt="">
    ...
    <form action="C10details.php" method="post">
        <div class="Product-info">
            <div class="Bookinfo">
                <p class="Name">CAPUCCINO VIENNA</p>
                <p class="About">US.</p>
                <p class="Type">COFFEE: Hot drinks</p>
                <p class="Price">¥ 15.50<span>税込</span></p>
            </div>
            <div class="desc">
...
<script>
    ...
    var images = ['CoffeeProduct/c10.png', 'image2.jpg'];
    var currentIndex = 0;
