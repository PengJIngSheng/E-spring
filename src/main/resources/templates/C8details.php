...
<div class="Keeper">
    <div class="Product-image">
        ...
        <p class="p2">/</p>
        <p class="p3">02</p>
        <img src="CoffeeProduct/c8.png" alt="">
    ...
    <form action="C8details.php" method="post">
        <div class="Product-info">
            <div class="Bookinfo">
                <p class="Name">MACCHIATO</p>
                <p class="About">US.</p>
                <p class="Type">COFFEE: Classics</p>
                <p class="Price">¥ 19.10<span>税込</span></p>
            </div>
            <div class="desc">
...
<script>
    ...
    var images = ['CoffeeProduct/c8.png', 'image2.jpg'];
    var currentIndex = 0;
