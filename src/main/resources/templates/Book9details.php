...
<div class="Keeper">
    <div class="Product-image">
        ...
        <p class="p2">/</p>
        <p class="p3">02</p>
        <img src="BookProduct/BP9.png" alt="">
    ...
    <form action="Book9details.php" method="post">
        <div class="Product-info">
            <div class="Bookinfo">
                <p class="Name">LITTLE WOMEN</p>
                <p class="About">Louisa May Alcott. US</p>
                <p class="Type">BOOK: ADVENTURE / HORROR</p>
                <p class="Price">¥ 38.40<span>税込</span></p>
            </div>
            <div class="desc">
...
<script>
    ...
    var images = ['BookProduct/BP9.png', 'image2.jpg'];
    var currentIndex = 0;
    ...
    buttons.forEach(button => {
        ...
        button.addEventListener('click', () => {
            ...
            xhr.open('POST', 'Book9details.php');
