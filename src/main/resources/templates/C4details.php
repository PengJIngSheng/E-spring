...
<div class="Keeper">
    <div class="Product-image">
        ...
        <p class="p2">/</p>
        <p class="p3">02</p>
        <img src="CoffeeProduct/c4.png" alt="">
    ...
    <form action="C4details.php" method="post">
        <div class="Product-info">
            <div class="Bookinfo">
                <p class="Name">TIRAMISU ESPRESSO</p>
                <p class="About">US.</p>
                <p class="Type">COFFEE: Cold drinks</p>
...
<script>
    ...
    var images = ['CoffeeProduct/c4.png', 'image2.jpg'];
    var currentIndex = 0;
