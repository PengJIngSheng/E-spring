...
<div class="Keeper">
    <div class="Product-image">
        ...
        <p class="p2">/</p>
        <p class="p3">02</p>
        <img src="BookProduct/BP2.png" alt="">
    ...
    <form action="Book2details.php" method="post">
        <div class="Product-info">
            <div class="Bookinfo">
                <p class="Name">PRIDE AND PREJUDICCE</p>
                <p class="About">Jane Austen. FR</p>
                <p class="Type">BOOK: ADVENTURE / HORROR</p>
                <p class="Price">¥ 44.10<span>税込</span></p>
            </div>
            <div class="desc">
...
<script>
    ...
    var images = ['BookProduct/BP2.png', 'image2.jpg'];
    var currentIndex = 0;
    ...
    buttons.forEach(button => {
        ...
        button.addEventListener('click', () => {
            ...
            xhr.open('POST', 'Book2details.php');
