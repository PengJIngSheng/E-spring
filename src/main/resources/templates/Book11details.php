...
<div class="Keeper">
    <div class="Product-image">
        ...
        <p class="p2">/</p>
        <p class="p3">02</p>
        <img src="BookProduct/BP11.png" alt="">
    ...
    <form action="Book11details.php" method="post">
        <div class="Product-info">
            <div class="Bookinfo">
                <p class="Name">THE JUNGLE BOOKS</p>
                <p class="About">Rudyard Kipling</p>
                <p class="Type">BOOK: ADVENTURE / HORROR</p>
                <p class="Price">¥ 78.50<span>税込</span></p>
            </div>
            <div class="desc">
...
<script>
    ...
    var images = ['BookProduct/BP11.png', 'image2.jpg'];
    var currentIndex = 0;
    ...
    buttons.forEach(button => {
        ...
        button.addEventListener('click', () => {
            ...
            xhr.open('POST', 'Book12details.php');
