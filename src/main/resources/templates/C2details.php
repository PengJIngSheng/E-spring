...
<div class="Keeper">
    <div class="Product-image">
        ...
        <p class="p2">/</p>
        <p class="p3">02</p>
        <img src="CoffeeProduct/c2.png" alt="">
    ...
    <form action="C2details.php" method="post">
        <div class="Product-info">
            <div class="Bookinfo">
                <p class="Name">GREEK CAPPUCCINO</p>
                <p class="About">US.</p>
...
<script>
    ...
    var images = ['CoffeeProduct/c2.png', 'image2.jpg'];
    var currentIndex = 0;
