...
<div class="Keeper">
    <div class="Product-image">
        ...
        <p class="p2">/</p>
        <p class="p3">02</p>
        <img src="BookProduct/BP12.png" alt="">
    ...
    <form action="Book12details.php" method="post">
        <div class="Product-info">
            <div class="Bookinfo">
                <p class="Name">THE INVISIBLE MAN</p>
                <p class="About">H.G. Wells. NG</p>
                <p class="Type">BOOK: ADVENTURE / HORROR</p>
                <p class="Price">¥ 44.50<span>税込</span></p>
            </div>
            <div class="desc">
...
<script>
    ...
    var images = ['BookProduct/BP12.png', 'image2.jpg'];
    var currentIndex = 0;
