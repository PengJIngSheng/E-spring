...
<div class="Keeper">
    <div class="Product-image">
        ...
        <p class="p2">/</p>
        <p class="p3">02</p>
        <img src="BookProduct/BP6.png" alt="">
    ...
    <form action="Book6details.php" method="post">
        <div class="Product-info">
            <div class="Bookinfo">
                <p class="Name">DREAM PSYCHOLOGY</p>
                <p class="About">Sigmund Freud. AU</p>
                <p class="Type">BOOK: ADVENTURE / HORROR</p>
                <p class="Price">¥ 32.80<span>税込</span></p>
            </div>
            <div class="desc">
...
<script>
    ...
    var images = ['BookProduct/BP6.png', 'image2.jpg'];
    var currentIndex = 0;
    ...
    buttons.forEach(button => {
        ...
        button.addEventListener('click', () => {
            ...
            xhr.open('POST', 'Book6details.php');
