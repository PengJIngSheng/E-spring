...
if ($_SERVER["REQUEST_METHOD"] == 'POST' && isset($_POST["submit"])) {
    ...
    if (preg_match('/^[a-zA-Z]{4,16}$/', $trimmed['name'])) {
        $name = $trimmed['name'];
    } else {
    ...
    if (preg_match('/^[0|1|2|3|4|6|7|8|9]\-*[0-9]{7,14}$/', $trimmed['contact'])) {
        $contact = $trimmed['contact'];
    } else {
        echo '<script>alert("Please enter your contact!");</script>';
    }

    if (mb_strlen($trimmed['message'], 'UTF-8') <= 300 && preg_match('/^[\x{4e00}-\x{9fa5}a-zA-Z\s]+$/u', $trimmed['message'])) {
        $message = $trimmed['message'];
    } else {
        echo '<script>alert("Please enter a valid message!");</script>';
    }

    $flag = sendMail('mier31028@gmail.com', 'report', $name, $email, $contact, $message);

    if ($flag) {
        echo '<script>alert("Message send");</script>';
    } else {
        echo '<script>alert("Cannot send");</script>';
    }
}
?>
<!DOCTYPE html>
...
<form action="Contact.php" method="post" novalidate="novalidate">
    ...
    <div class="Text1">
        <p>
            If u face any problems, feel free to ask contact us
        </p>
    </div>
    ...
    <div class="Name-input">
        <input type="text" name="name" id="" value="<?php if (isset($trimmed['name'])) echo $trimmed['name']; ?>"/>
    </div>
    <div class="Email-label">
        <p>Email*</p>
    </div>
    <div class="Email-input">
        <input type="email" name="email" id="" value="<?php if (isset($trimmed['email'])) echo $trimmed['email']; ?>"/>
    </div>
    ...
    <div class="Contact-input">
        <input type="tel" name="contact" id=""
               value="<?php if (isset($trimmed['contact'])) echo $trimmed['contact']; ?>"/>
    </div>
    <div class="Message-label">
        <p>Message*</p>
    </div>
    <div class="Message-input">
        <textarea placeholder="Enter soemthing" name="message" value="<?php if (isset($trimmed['message'])) echo $trimmed['message']; ?>"></textarea>
    </div>
    <div class="Text2">
        <p>
    ...
    <div class="Submit-button">
        ...
        <button id="work" type="submit" name="submit">SUBMIT</button>
    </div>
    <br/><br/><br/>
